  ...
  return (
    <>
      <div className='store-container'>
        <a href="https://business.juso.go.kr/addrlink/addrLinkUrl.do"></a>
        ...
        <div>
          <input id="store-name" className='store-input' placeholder='가게 이름을 입력해주세요'/>
        </div>
        <h3 className='store-item'>주소</h3>
        <div>
          <input id="store-address" className='store-input' placeholder='가게 주소를 입력해주세요'/>
        </div>
        ...
        <div>
          <input id="store-open-time" className='store-input' type="time" style={{width: "20vh"}} /> ~ <input id="store-close-time" className='store-input' type="time" style={{width: "20vh"}} />
        </div>
        <h3 className='store-item'>가게 소개</h3>
        <div>
          <textarea id="store-introduction" className='store-input' placeholder='내 가게를 소개해주세요' rows={4}/>
        </div>
        <h3 className='store-item'>최소 주문 금액</h3>
        <div>
          <input id="minimum-order-amount" className='store-input' placeholder='최소 주문 금액을 입력해주세요'/>
        </div>
        <h3 className='store-item'>가게 전화 번호</h3>
        <div>
          <input id="store-phone-number" className='store-input' placeholder='가게 전화 번호를 입력해주세요'/>
        </div>
        <div>
